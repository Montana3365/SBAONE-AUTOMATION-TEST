...
//import org.openqa.selenium.support.ui.Select;
	...
	public class US788_Collapse_Navigation_Pane_LLC_WOSB {
	  ...
	  private StringBuffer verificationErrors = new StringBuffer();
		...
		Login="akanamontana@mailinator.com";
...
//		setting up IE, Chrome, and FireFox Web Drivers
	  ...
	  //Verify if there is an existing certification on the dashboard and delete to start a new certification.
		...
		//Step 6 - Verify that user is navigated to the Correct section(Signature).
...
//Start of US788
		...
		//Step 10 - Verify that the Third Party Certification section was expanded				
		...
		//Step 16 - Verify that the Third Party Certification section was collapsed				
