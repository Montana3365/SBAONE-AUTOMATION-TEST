...
//	    driver=new ChromeDriver();
	  ...
	  //Verify if there is an existing certification on the dashboard and delete to start a new certification.
			if(driver.getPageSource().contains("Draft")){
				...
				System.out.println("There was no WOSB certification in-progress on the dashboard, a new certification is being created");
			}
			
			
		//Step 2 - Answer questions for WOSB application
		// Locate the Certifications on the dashboard, click on it and select WOSB to continue.
			...
			Thread.sleep(2000);
		//Locate the accept button at the bottom of the WOSB agreement and click on it to continue.
...
//Verify that Non Corp applicant's don't see Corp questions
		  ...
		  //Step 3 - Verify that the second question needs to be answered before moving on.
		    System.out.println("Step 3 - Verify that the second question needs to be answered before moving on");
		    driver.findElement(By.xpath(".//*[@id='wosb']/input[4]")).click();
		    try {
				assertEquals("Please answer this question", driver.findElement(By.xpath(".//*[@id='answers[25][value]-error']")).getText());
		...
		//Step 6 - Verify that the Expertise & Employment screen is displayed
			...
			try {
				assertEquals("Expertise & Employment", driver.findElement(By.xpath(".//*[@id='main-content']/div/h2")).getText());
		...
		//Step 7 - Return to the Operations & Management screen
			...
			try {
				assertEquals("Operations & Management", driver.findElement(By.xpath(".//*[@id='main-content']/div/h2")).getText());
		...
		//Step 9 - Verify that the Upload button is displayed
			...
			try {
				assertEquals("Upload", driver.findElement(By.xpath(".//*[@id='answers[25][attachment]']/div/label")).getText());
		...
		//Step 10 - Verify that a upload is optional by clicking the Save and continue button
