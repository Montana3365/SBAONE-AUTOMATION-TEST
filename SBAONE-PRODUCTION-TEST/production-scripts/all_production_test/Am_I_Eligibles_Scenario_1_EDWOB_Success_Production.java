package all_production_test;
	...
	public class Am_I_Eligibles_Scenario_1_EDWOB_Success_Production {
	...
	public void AM_I_Eligible_maintest()throws Exception{
		...
		//Test script 1, Scenario 1: User should be eligible for the WOSB program
	...
	//Step 17. Enter an valid WOSB code for Question Three ( <6 or >6 Digit NAICS Code).
	...
	//Step 20. Select NO for Question Four.
	    ...
	    Thread.sleep(4000);
	//Step 21. Click on "Check Eligibility" Button at the button of the four Questions.
	    mydriver.findElement(By.xpath(".//*[@id='am_i_eligible']/input[4]")).click();
	    Thread.sleep(4000);
	//step 22. Show result base on information enter in the Questionnaire you may be eligible for WASB AND NNOT EDWASB program set-asides, see result).
