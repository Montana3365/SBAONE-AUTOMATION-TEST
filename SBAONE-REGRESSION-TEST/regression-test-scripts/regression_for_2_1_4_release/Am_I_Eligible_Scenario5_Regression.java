...
public class Am_I_Eligible_Scenario5_Regression {
...
//Scenario 5, User answer "Yes" to all questions and leave the NAICS Code box empty.
System.out.println("-Test script 1, Scenario 5: WOSB Program Eligibility - Low Fidelity Failure Due to omition of the NAICS Code ");
...
//Step 15. Enter an invalid WOSB code for Question Three ( 6 Digit INVALID NAICS Code).
//mydriver.findElement(By.xpath(".//*[@id='answers_3_value']")).sendKeys(Six_invalid_code); 
//Step 16. Select Yes for Question Four.
...
System.out.println("Csenario 5  omited NAICS Code test validated");
...
//Step 18. Select Yes for Question Four.
...
Thread.sleep(5000);
//Look for the omitted question alert and validate it to ensure its appears for users to type in the valid code when omitted.
if(mydriver.getPageSource().contains("Please answer this question")){
System.out.println("Omited answer box alert activated, negative Csenario 5 pass");
}
else{
System.out.println("Omited answer box alert not activated, negative Csenario 5 Failed");  
}
}
@After
