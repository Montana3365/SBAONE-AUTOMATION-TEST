...
//		String exePath = "C:\\Users\\Jonathan Whitley\\Documents\\NEW-SBAONE-SCRIPTS\\SBAONE_AUTOMATION\\src\\library\\chromedriver.exe";
...
//		setting up IE Driver
	  ...
	  //Verify if there is an existing certification on the dashboard and delete to start a new certification.
		...
		//Locate the Third Party Certification, question1 and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Third Party Certification, question3 and select No and continue.
			driver.findElement(By.xpath(".//*[@id='answers[68][value]']/label[2]")).click();
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
			System.out.println("  Third Party questions have been answered");
		//Locate the Business Corporation and S-Corp question 1 - 7 and continue.
		//answer No radio button for the 1st Corp question
			driver.findElement(By.xpath(".//*[@id='answers[69][value]']/label[2]")).click();
		//add comment
			driver.findElement(By.xpath(".//*[@id='answers_69_comment']")).sendKeys(comment);
		//click the Yes radio button for the 2nd Corp question
			driver.findElement(By.xpath(".//*[@id='answers[70][value]']/label[1]")).click();
		//click the Yes radio button for the 3rd Corp question
			driver.findElement(By.xpath(".//*[@id='answers[71][value]']/label[1]")).click();
		//click the Continue button	
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();	
		//click the Yes radio button for the 4th Corp question
			driver.findElement(By.xpath(".//*[@id='answers[72][value]']/label[1]")).click();  
		//click the Continue button		    	
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();	
		//click the Yes radio button for the 5th Corp question
			driver.findElement(By.xpath(".//*[@id='answers[73][value]']/label[1]")).click();  
		//click the Continue button		    	
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//click the Yes radio button for the 6th Corp question
			driver.findElement(By.xpath(".//*[@id='answers[74][value]']/label[1]")).click();  
		//click the Continue button		    	
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//click the No radio button for the 7th Corp question
			driver.findElement(By.xpath(".//*[@id='answers[75][value]']/label[2]")).click();  
		//add comment
			driver.findElement(By.xpath(".//*[@id='answers_75_comment']")).sendKeys(comment);
		//click the Continue button				
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();			
			System.out.println("  Business questions have been answered");
		//Locate the Operations Part1, question 1and2, and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Operations Part2, question 3and4, and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Operations Part3, question 5and6, and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Operations Part4, question 7and8, and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Operations Part5, question 9and10, and select No and continue.
			...
			driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		//Locate the Operations Part6, question 11and12, and select No and continue.
		...
		//Step 3 - Create an Owner and fill out the Form 413 pages until the Stocks & Bonds window
		...
		//Verify that users is navigated to the right page for EDWOSB 2413 and 414 Application >> Form413 >> James Thompson, Verify question and select YES OR NO to the question as apply to user and continue.
				if(driver.getPageSource().contains("Notes Receivable")){
					System.out.println("User is being navigated to the financial information(413), Notes Receivable page, PASS");
					
				}
				else{
					System.out.println("User is not being navigated to the financial information(413), Notes Receivable page, <<FAILED>>");
			         Thread.sleep(2000);
			         driver.quit();
		...
		//Verify that user is navigated to the Correct section(Retirement Accounts).
		...
		//Locate the Retirement Accounts questions 1 and 2, and select No and continue.
		...
		//Locate the Life Insurance questions 1, 2, 3, and select No and continue.
		...
		//Step 5 - Verify that user is navigated to the Correct section(Stocks & Bonds).
		...
		//Step 17 - Verify that user is navigated to the Correct section(Cash On Hand).
				System.out.println("Step 17 - Verify that user is navigated to the Correct section(Other Sources Of Income)");
				try {
				assertEquals("Other Sources Of Income", driver.findElement(By.xpath(".//*[@id='main-content']/div/h2")).getText());
...
//Start of US788
		...
		//Step 21 - Verify that the Third Party Certification section was expanded				
		...
		//Step 23 - Verify that the Business section was expanded				
				...
				if(driver.getPageSource().contains("Corp")){
		...
		//Step 24 - Click to expand the Corporation section			
				System.out.println("Step 24 - Click to expand the Corporation section");
				driver.findElement(By.xpath(".//*[@id='corporation']")).click();		
		
				
		//Step 25 - Verify that the Corporation section was expanded				
				System.out.println("Step 25 - Verify that the Corporation section was expanded");
				try {
					assertEquals("Stocks", driver.findElement(By.xpath(".//*[@id='corp1']")).getText());
					System.out.println("  Corporation section expanded - Pass");  
				} catch (Error e) {
					verificationErrors.append(e.toString());
					System.out.println("  Corporation section expanded - <<FAILED>>");
					driver.quit();
				}
				Thread.sleep(2000);			
		...
		//Step 27 - Verify that the Operations section was expanded				
				...
				try {
					assertEquals("Citizenship & Ownership", driver.findElement(By.xpath(".//*[@id='operations_part_1']")).getText());
		...
		//Step 31 - Verify that the Third Party Certification section was collapsed				
		...
		//Step 35 - Verify that the Corporation section was collapsed				
				System.out.println("Step 35 - Verify that the Corporation section was collapsed");
				try {
					assertEquals("Stocks", driver.findElement(By.xpath(".//*[@id='corp1']")).getText());
					System.out.println("  Corporation section collapsed - <<FAILED>>");  
					driver.quit();
				} catch (Error e) {
					verificationErrors.append(e.toString());
					System.out.println("  Corporation section collapsed - Pass");
				}
				Thread.sleep(2000);
		...
		//Step 37 - Verify that the Business section was collapsed				
				...
				try {
					assertEquals("Corporation & S-Corp", driver.findElement(By.xpath(".//*[@id='js-navigation-menu2']/li[1]/span")).getText());
		...
		//Step 43 - Verify that the Financial section for James Thompson was collapsed				
				System.out.println("Step 43 - Verify that the Financial section for James Thompson was collapsed");
				try {
					assertEquals("Cash On Hand", driver.findElement(By.xpath(".//*[@id='cash_on_hand_james_thompson']")).getText());
		...
		//Step 45 - Verify that the Financial section for Peter Smith was collapsed				
				System.out.println("Step 45 - Verify that the Financial section for Peter Smith was collapsed");
				try {
					assertEquals("Cash On Hand", driver.findElement(By.xpath(".//*[@id='cash_on_hand_peter_smith']")).getText());
		...
		//Step 47 - Verify that the Financial section for James Thompson was expanded				
		...
		//Step 49 - Verify that the Financial section for Peter Smith was expanded				
