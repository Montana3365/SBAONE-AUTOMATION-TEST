package regression_for_2_1_4_release;
	...
	public class US633_EDWOSB_No_Self_CertifiesApplicant_RealEstate_Primary_Residence_FM_Regression {
	...
	@Before
	public void EDWOSB_No_Self_CertifiesApplicant_RealEstate_Primary_Residence_Setup(){
	...
	// Data for Primary Residence 
		    ...
		    CurrentbalanceLean="1000";
		    CalculatedAnnually="11000";
	}
	@Test 
	public void EDWOSB_No_Self_CertifiesApplicant_RealEstate_Primary_Residence_MainTest() throws Exception{
		...
		Thread.sleep(2000);
		try {
			assertEquals("Create new entry", driver.findElement(By.xpath("html/body/div[3]/div/div/div/div[1]/div[1]/div")).getText());
		...
		//Locate the Total Value box and enter the total amount.
		 ...
		 // Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='DTE_Field_type']")));
		 // oSelect.selectByVisibleText("Roth IRA");
		 //driver.findElement(By.xpath(".//*[@id='DTE_Field_type']")).clear();
		...
		driver.findElement(By.xpath(".//*[@id='DTE_Field_initial_contribution']")).sendKeys(rothira_initial_contribution);
		...
		driver.findElement(By.xpath(".//*[@id='answers[42][value]']/label[1]")).click();
		//Click New and verify that the Create new entry window opens for the Other Retirement.	
		//Create a New row
		...
		//Fill out the below values for second record and click the Create button to create a new record				
		...
		//Locate the Market Value Quotation/Exchange box and enter market value.
		...
		//Locate the Interest & Dividends Received box and enter the Interest & Dividends Received.
		...
		// Beginning the US633 Here 
					
		//SVerify if there is Real Estate - Primary Residence page.
					
					try { 
						assertEquals("Real Estate - Primary Residence", driver.findElement(By.xpath(".//*[@id='main-content']/h2")).getText()); 
						System.out.println("User is navigated to the Correct section, (Real Estate - Primary Residence) - Pass"); 
					 	} catch (Error e) { 
						verificationErrors.append(e.toString()); 
						System.out.println("User is NOT being navigated to the Correct section, (Real Estate - Primary Residence) - FAILED");
						Thread.sleep(3000);
						driver.quit();
						} 
					//Locate the Real Estate - Primary Residence questions, Continue without selecting anything.
					System.out.println("Tried to continue without answering the two question - Pass");
					driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
					  try {
						  assertEquals("Please answer this question", driver.findElement(By.xpath(".//*[@id='answers[47][value]-error']")).getText());
						  System.out.println("Tried to continue without answering the Do you own your primary residence? question - Pass");
					  } catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("Step 5 - Tried to continue without answering the Do you own your primary residence? question - FAILED");
					  }
					//Locate the Real Estate - Primary Residence questions select No and continue.
						driver.findElement(By.xpath(".//*[@id='answers[47][value]']/label[2]")).click();
						driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
						System.out.println("No was selected and the Continue button was clicked");
						Thread.sleep(2000);
						//Verify that user is navigated to the Correct section(Real Estate - Other).
						try {
							assertEquals("Real Estate - Other", driver.findElement(By.xpath(".//*[@id='main-content']/h2")).getText());
							System.out.println("Real Estate - Other page is displayed - Pass");
						} catch (Error e) {
							verificationErrors.append(e.toString());
							System.out.println("Real Estate - Other page is displayed - FAILED");
						}
						Thread.sleep(2000);
						//Return to the Real Estate - Primary Residence page
						driver.findElement(By.xpath(".//*[@id='real_estate_primary_sabra_mabella']")).click();
						Thread.sleep(2000);
						try {
							assertEquals("Real Estate - Primary Residence", driver.findElement(By.xpath(".//*[@id='main-content']/h2")).getText());
							System.out.println("User is returned to the correct section (Real Estate - Primary Residence) - Pass");
						} catch (Error e) {
							verificationErrors.append(e.toString());
							System.out.println("User is NOT returned to the Correct section (Real Estate - Primary Residence) - FAILED");
						}
					  Thread.sleep(2000);
					//Locate the Real Estate - Primary Residence questions, select Yes to the first question, Without  answer any other question, and click the Continue button.
					  System.out.println("Locate the Real Estate - Primary Residence questions, select Yes to the first question, Without answer any other question, and click the Continue button.");	
					  //Real Estate - Primary Residence select Yes
					  driver.findElement(By.xpath(".//*[@id='answers[47][value]']/label[1]")).click();
					 
					Thread.sleep(2000);
					driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers_48_2_1_value-error']")).getText());
						  System.out.println("Error message displayed for What is the address of your primary residence? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers[48][2][2][value]-error']")).getText());
						  System.out.println("Error message displayed for Is your primary residence jointly owned? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers[48][2][5][value]-error']")).getText());
						  System.out.println("Error message displayed for Is your name on the mortgage? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers_48_2_6_value-error']")).getText());
						  System.out.println("Error message displayed for What is the current value of your primary residence? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers_48_2_7_value-error']")).getText());
						  System.out.println("Error message displayed for What is the mortgage balance on your primary residence? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers[48][2][8][value]-error']")).getText());
						  System.out.println("Error message displayed for Is there a lien, 2nd mortgage or Home Equity Line of Credit on your primary residence? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					try {
						  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers[48][2][10][value]-error']")).getText());
						  System.out.println("Error message displayed for Do you receive income from your primary residence (rent, etc.)? - Pass");
					} catch (Error e) {
						  verificationErrors.append(e.toString());
						  System.out.println("  Error message displayed Real Estate - Primary Residence - FAILED");
					}
					...
					System.out.println("What percentage of ownership do you have in your primary residence? '50%'");
					...
					System.out.println("What percentage of the mortgage are you responsible for in your primary residence? '50%");
					driver.findElement(By.xpath(".//*[@id='answers_48_2_4_value']")).sendKeys(PercentageOfmortgage);
					//Is your name on the mortgage?
					System.out.println("Is your name on the mortgage? Select 'Yes'");
					//driver.findElement(By.xpath("//div[@id='answers[48][2][5][value]']/label")).click();
					driver.findElement(By.xpath(".//*[@id='answers[48][2][5][value]']/label[1]")).click();;
					//What is the current value of your primary residence?
					System.out.println("What is the current value of your primary residence? '10000'");
					...
					System.out.println("What is the mortgage balance on your primary residence? '10000'");
					driver.findElement(By.xpath(".//*[@id='answers_48_2_7_value']")).sendKeys(MortgageBalance);
					//Is there a lean, 2nd mortgage or Home Equity Line of Credit on your primary residence?
					System.out.println("Is there a lien, 2nd mortgage or Home Equity Line of Credit on your primary residence? Select 'Yes'");
					driver.findElement(By.xpath(".//*[@id='answers[48][2][8][value]']/label[1]")).click();
					//What is the current balance of the lean(s)?
					System.out.println("What is the current balance of the lean(s)?");
					driver.findElement(By.xpath(".//*[@id='answers_48_2_9_value']")).sendKeys(CurrentbalanceLean);
					//Do you receive income from your primary residence (rent, etc.)?click "Yes"
					System.out.println("Do you receive income from your primary residence (rent, etc.)? Select 'Yes'");
					...
					System.out.println("What is the income YOU receive from your primary residence (calculated annually)?");
					driver.findElement(By.xpath(".//*[@id='answers_48_2_11_value']")).sendKeys(CalculatedAnnually);
					
					driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
					Thread.sleep(2000);
									
				//Step 3. Verify that users is navigated to the right page for EDWOSB 2413 and 414 Application >> Form413 >>Verify question and select YES OR NO to the question as apply to user and continue.	
				 if(driver.getPageSource().contains("Real Estate - Other")){
					System.out.println("User is being navigatd to the financial information(413), Real Estate - Other page, PASS");
				...
				//Verify The primary residence address is being saved
				 if(driver.getPageSource().contains("5000 K Street NW, Washington DC")){
				 ...
				 Thread.sleep(3000);
				//Verify What percentage of ownership do you have in your primary residence? is being saved
				 if(driver.getPageSource().contains("50")){
					System.out.println("What percentage of ownership do you have in your primary residence? is being saved, Pass"); 
				 }
				 else{
						System.out.println("What percentage of ownership do you have in your primary residence? is not being saved, Faild"); 
				 }			 
				 Thread.sleep(3000);
				 
				//Verify What percentage of the mortgage are you responsible for in your primary residence? is being saved
				 if(driver.getPageSource().contains("50")){
					System.out.println("What percentage of the mortgage are you responsible for in your primary residence? is being saved, Pass"); 
				 }
				 else{
						System.out.println("What percentage of the mortgage are you responsible for in your primary residence? is not being saved, Faild"); 
				 }			 
				 Thread.sleep(3000);

				//Verify What is the current value of your primary residence? is being saved
				 ...
				 Thread.sleep(3000);
				//Verify What is the mortgage balance on your primary residence? is being saved
				 if(driver.getPageSource().contains("10000")){
				...
				//Verify What is the current balance of the lien(s)? is being saved
				...
				//Verify What is the income YOU receive from your primary residence (calculated annually)? is being saved
				 if(driver.getPageSource().contains("11000")){
					System.out.println("What is the income YOU receive from your primary residence (calculated annually)? is being saved, Pass"); 
					System.out.println(driver.findElement(By.xpath(".//*[@id='edwosb']")).getText());
				 }
				 else{
						System.out.println("What is the income YOU receive from your primary residence (calculated annually)? is not being saved, Faild"); 
				 }
					}
	...
	@After
	public void EDWOSB_Yes_No_Self_CertifiesApplicant_RealEstate_Primary_Residence_EndTest(){
		driver.quit();
