...
public class Am_I_Eligible_Scenario4_Regression {
...
//Scenario 3, User answer no to all questions and entered an invalid NAICS code.
    System.out.println("-Test script 1, Scenario 4: WOSB Program Eligibility - Low Fidelity Failure Due to an invalid NAICS code");
...
//Step 5. Print out "First Question" if present.
	...
	System.out.println(mydriver.findElement(By.xpath(".//*[@id='am_i_eligible']/ul/li[1]/div[1]")).getText());
...
//Step 19. Click on "Check Eligibility" Button at the button of the four Questions.
	...
	Thread.sleep(4000);
//step 20. Show result base on information enter in the Questionnaire(Based on your answers,you should as "The NAICS code entered does not appear on the list of designated industries").
