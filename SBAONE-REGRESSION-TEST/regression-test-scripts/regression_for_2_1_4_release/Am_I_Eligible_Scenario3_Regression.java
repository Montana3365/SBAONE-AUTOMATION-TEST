...
public class Am_I_Eligible_Scenario3_Regression {
...
//Scenario 3, User answer no to all questions and entered an invalid NAICS code.
    System.out.println("-Test script 1, Scenario 3: WOSB Program Eligibility - Low Fidelity Failure Due to 'NO' for all the questions and an invalid NAICS");
...
//Step 14. Select NO for Question Two.
...
//Step 19. Click on "Check Eligibility" Button at the button of the four Questions.
	...
	Thread.sleep(4000);
//step 20. Show result base on information enter in the Questionnaire(Based on your answers, you may be eligible, see result).
