...
public class US862_SBA_Analyst_Cloning_Sends_Certification_Back_to_Vendor {
	...
	//Locate the Sign-in button and click on it to login.
		...
		Thread.sleep(3000); 
	//Locate the Search for a vendor search box and enter a valid duns number.
    ...
    //Verify that the analyst is able to send an active certification back to the vendor for review.
		Thread.sleep(3000);
