package regression_for_2_1_4_release;
	...
	public class EDWOSB_Other_Real_State_US649_FM_Regression {
		...
		// Data for Other Real State
			...
			Thread.sleep(2000);
					...
					//Is there a lean, 2nd mortgage or Home Equity Line of Credit on your primary residence? Click "Yes"
					...
					//Step 1 - Locate the Real Estate - Other questions, Continue without selecting anything.
							//System.out.println("Tried to continue without answering the two question - Pass");					driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();					  try {						  assertEquals("Please answer this question", driver.findElement(By.xpath(".//*[@id='answers[41][value]-error']")).getText());						  System.out.println("Tried to continue without answering the Roth IRA question - Pass");					  } catch (Error e) {						  verificationErrors.append(e.toString());						  System.out.println("Tried to continue without answering the ROTH IRA question - FAILED");					  }
					//Step 2 - Locate the Real Estate - Other questions select No and continue.
					...
					//Step 3 - Verify that user is navigated to the Correct section(Personal Property).
					try {
						assertEquals("Personal Property", driver.findElement(By.xpath(".//*[@id='main-content']/div/h2")).getText());
				...
				//Step 5 - Locate the Real Estate - Other questions, select Yes to the first question, don't add a row, and click the Continue button.
				  System.out.println("Step 5 - Locate the Real Estate - Other questions, select Yes to the first question, don't add a row, and click the Continue button.");	
				...
				driver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
				try {
					  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers_50_2_1_value-error']")).getText());
					  ...
					  assertEquals("This field is required.", driver.findElement(By.xpath(".//*[@id='answers_50_2_6_value-error']")).getText());
					  ...
					  System.out.println("Is there a lien, 2nd mortgage or Home Equity Line of Credit on your Other Real Estate?");
				...
				//Step 6 - Enter charters into numeric field and click the Create button	
					...
					//Step 8 - Clear the text boxes				
						...
						//Verify if there is Real Estate - Primary Residence page.
								if(driver.getPageSource().contains("List your other real estate holdings:")){
									...
									//List your other real estate holdings: coming up "Add" Click other real estate holdings information
									...
									//What percentage of ownership do you have in your Other Real Estate?
								    ...
								    //What percentage of the mortgage are you responsible for in your Other Real Estate?
								   ...
								   System.out.println("Mortgage_Balance_ORE= 10000");
									...
									//Is there a lean, 2nd mortgage or Home Equity Line of Credit on your Other Real Estate? "Yes"
									...
									//Do you receive income from your Other Real Estate (rent, etc.)? "Yes"	
									 driver.findElement(By.xpath(".//*[@id='answers[50][2][10][value]']/label[1]")).click();
									 //What is the income YOU receive from your Other Real Estate (calculated annually)?
