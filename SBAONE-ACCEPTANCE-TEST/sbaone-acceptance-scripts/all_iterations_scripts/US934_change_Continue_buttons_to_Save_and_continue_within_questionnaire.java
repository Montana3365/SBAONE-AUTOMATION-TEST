package all_iterations_scripts;
	...
	*/
	...
	Thread.sleep(3000);	//Select NO the Retirement Account question one and two and continue.
	...
	if(mydriver.getPageSource().contains("Privacy Statements")){
		...
		System.out.println("Pual Washington Did Not successfully navigated to the Privacy Statements Page on form413, Failed");
	    mydriver.quit();
	}
	//////////
	...
	//Verify that user1 is being navigated to the section; 'Cash on Hand' on Form413.
	...
	//Go back to the form413 and verify that data entered by user2 are being saved and click on the continue button.
	mydriver.findElement(By.xpath(".//*[@id='form413']")).click();
	Thread.sleep(3000);
	if(mydriver.getPageSource().contains("Danzel")){
		...
		System.out.println("-User2 Personal Information entered on form413 are Not being successfully saved, Failed");
	}
	...
	//Verify that Danzel Washington is being prompted to enter His Financial information.
	 ...
	 //Verify that Danzel navigates to the Cash on hand section.
		if(mydriver.getPageSource().contains("Cash On Hand")){
			System.out.println("-Danzel Washington Successfully navigated to the Cash On Hand Section on Form413, Pass");
			...
			Thread.sleep(3000);		    //Select Yes for Real Estate - Primary Residence Section questions.
			mydriver.findElement(By.xpath(".//*[@id='answers[47][value]']/label[1]")).click();
			Thread.sleep(4000);
			mydriver.findElement(By.id("answers_48_2_1_value")).sendKeys(P_Resident);
			mydriver.findElement(By.xpath(".//*[@id='answers[48][2][2][value]']/label[1]")).click();
		    ...
		    Thread.sleep(3000);	
		//Beginning Test For Personal Property.
			//Verify and Select Yes for the quetion; 'Do you own any automobiles?'.
			if(mydriver.getPageSource().contains("Do you own any automobiles")){
				System.out.println("-User is being navigated to the Personal Property section, PASS");
			mydriver.findElement(By.xpath(".//*[@id='answers[51][value]']/label[1]")).click();
			//Locate the New button on the data table and click on it to add information.
		...
		//Verify and select YES for the next assessed taxes section question; 'Do you have any other liabilities?'.
				...
				Thread.sleep(3000);
		//Verify that User is being navigated to the 'Adjusted Gross Income' section of form 413.
				if(mydriver.getPageSource().contains("As shown on tax returns for Most Recent tax year")){
					System.out.println("-User navigated to the Adjusted Gross Income section of form 413 seccessfully, Pass");
			...
			if(mydriver.getPageSource().contains("Financial Summary")){
				...
				System.out.println("-Danzel Washington Did Not successfully navigated to the Summary Page on form413, Failed");
		         mydriver.quit();
			}
			...
			//Verify that user is being navigated to the Privacy Statements Page.
			if(mydriver.getPageSource().contains("Privacy Statements")){
				System.out.println("-Danzel Washington successfully navigated to the Privacy Statements Page on form413, Pass");
			}
			else{
				System.out.println("-Danzel Washington Did Not successfully navigated to the Privacy Statements Page on form413, Failed");
		        mydriver.quit();
			}
			if(mydriver.getPageSource().contains("Danzel Washington")){
				System.out.println("-Danzel Washington successfully navigated to the Privacy Statements Page on form413, Pass");
