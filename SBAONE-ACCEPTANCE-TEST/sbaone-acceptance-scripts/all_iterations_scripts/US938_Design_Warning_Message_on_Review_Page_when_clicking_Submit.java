package all_iterations_scripts;
   ...
   //Verify that user successfully navigated to the Review page.
	...
	//Verify that the Button to navigate to the next page reads Submit and click on it.
	...
	//Verify pop up message to validate that user is able to return back to review page to edit application.
	Thread.sleep(3000);
	if(mydriver.getPageSource().contains("Please verify all the information in your application")){
		...
		//Verify that there is a link in the pop up message to return user back to the review page to edit application.
...
//Verify that user is navigated back to the review page for edit.
	if(mydriver.getPageSource().contains("Financial Information")){
		System.out.println("user successfully navigated to the review page after clicking the return link in the pop up, Pass");
	}
	else{
		System.out.println("user did not successfully navigated to the review page after clicking the return link in the pop up, Failed");
	     mydriver.quit();
...
//Locate and click on the Submit button. 
	...
	if(mydriver.getPageSource().contains("Continue")){
		System.out.println("The Navigation button on the pop message to Navigate to the Signature page reads Continue, Pass");
		mydriver.findElement(By.xpath(".//*[@id='alert-continue-button']")).click();
		Thread.sleep(5000);
	}
	else{
		System.out.println("The Navigation button on the pop up message to the Signature page did dnot reads Submit, Failed");
	     mydriver.quit();
