...
//		driver.get(baseUrl);
  ...
  //Verify if there is an existing certification on the dashboard and delete to start a new certification.
	...
	//Step 2 -  Locate the Certifications on the dashboard, click on it and select EDWOSB to continue.
		System.out.println("Step 2 - Locate the Certifications on the dashboard, click on it and select EDWOSB to continue.");
	...
	//Step 3 - Locate the accept button at the bottom of the EDWOSB agreement and click on it to continue.
		System.out.println("Step 3 - Locate the accept button at the bottom of the EDWOSB agreement and click on it to continue.");
		if(driver.getPageSource().contains("Accept")){
			System.out.println("  The continue button on the Review was not change or updated to Save and continue - Pass");
		}
		else {
			System.out.println("  The continue button on the Review was change or updated to Save and continue - <<Failed>>");
			driver.quit();
		}
		Thread.sleep(2000);
	...
	//Step 4 - Locate the 8(a) question, select No, valid Save and continue button, and continue.
		System.out.println("Step 4 - Locate the 8(a) question, select No, valid Save and continue button, and continue.");
	...
	//Step 5 - Locate the Third Party Certification question1, valid Save and continue button, select Yes, attach a document, and continue.
		System.out.println("Step 5 - Locate the Third Party Certification question1, valid Save and continue button and select Yes, attach a document, and continue..");
		if (driver.getPageSource().contains("Save and continue")){
	  		System.out.println("  Save and continue button is displayed - Pass");
	  	} else {
			System.out.println("  Save and continue button is displayed - <<FAILED>>");
	...
	//Step 6 - Locate the Third Party Certification question2 and valid Save and continue button
		System.out.println("Step 6 - Locate the Third Party Certification question2 and valid Save and continue button");
		if (driver.getPageSource().contains("Save and continue")){
	  		System.out.println("  Save and continue button is displayed - Pass");
	  	} else {
			System.out.println("  Save and continue button is displayed - <<FAILED>>");
	...
	//Step 7 - Return to the Third Party Certification question1, select No, and continue
	...
	//Step 8 - Locate the Third Party Certification question3 and valid Save and continue button
		System.out.println("Step 8 - Locate the Third Party Certification question2 and valid Save and continue button");
		if (driver.getPageSource().contains("Save and continue")){
	  		System.out.println("  Save and continue button is displayed - Pass");
	  	} else {
			System.out.println("  Save and continue button is displayed - <<FAILED>>");
	...
	//Step 9 - Locate the Business Corporation and LLC questions 1 - 2, valid Save and continue button, and continue.
		System.out.println("Step 9 - Locate the Business Corporation and LLC questions 1 and 2, valid Save and continue button, and continue");
	...
	//Step 10 - Locate the Citizenship & Ownership question 1and2, and select No and continue.
		System.out.println("Step 10 - Locate the Citizenship & Ownership question 1 and 2, and select No and continue.");
	...
	//Step 11 - Locate the Businesses & Trusts question 3and4, and select No and continue.
	...
	//Step 12 - Locate the Operations & Management question 5and6, and select No and continue.
		System.out.println("Step 12 - Locate the Operations & Management question 5 and 6, and select No and continue.");
	...
	//Step 13 - Locate the Expertise & Employment, question 7and8, and select No and continue.
		System.out.println("Step 13 - Locate the Expertise & Employment, question 7 and 8, and select No and continue.");
	...
	//Step 14 - Locate the Highest Officer & Control question 9and10, and select No and continue.
		System.out.println("Step 14 - Locate the Highest Officer & Control question 9 and 10, and select No and continue.");
	...
	//Step 15 - Locate the SBA Exam & Daily Operations question 11and12, and select No and continue.
		System.out.println("Step 15 - Locate the SBA Exam & Daily Operations question 11 and 12, and select No and continue.");
	...
	//Step 16 - Locate the EDWOSB Net Worth questions, and select No and continue.
	...
	//Step 17 - Locate the EDWOSB Adjusted Gross Income questions, and select No and continue.
	...
	//Step 18 - Locate the EDWOSB Fair Market Value question, and select No and continue.
	...
	//Step 19 - Locate the EDWOSB Section4 questions, and select No and continue.
	...
	//Step 21 - Locate section for Cash on Hand enter all valid data as required.
	...
	//Locate the Cash on Hand Search box for WWW eee user and enter the information as required.
			driver.findElement(By.xpath(".//*[@id='answers_33_value']")).sendKeys(Cash_On_Hand);
	//Locate the Savings Account(s) Balance Search box for WWW eee user and enter the information as required.
			driver.findElement(By.xpath(".//*[@id='answers_34_value']")).sendKeys(Saving_Account);
	//Locate the Checking Account(s) Balance Search box for WWW eee user and enter the information as required.
	...
	//Step 22 - Locate section for Other Source of Income enter all valid data as required.
	...
	//Step 23 - Select No for Notes Receivable Question and verify the Save and continue button.
			System.out.println("Step 23 - Select No for Notes Receivable Question and verify the Save and continue button.");
	...
	//Step 24 - Locate the Retirement Accounts questions 1 and 2, select No, and verify the Save and continue button.
			System.out.println("Step 24 - Locate the Retirement Accounts questions 1 and 2, select No, and verify the Save and continue button.");
	...
	//Step 25 - Locate the Life Insurance questions 1, 2, 3, select No, and verify the Save and continue button.
			System.out.println("Step 25 - Locate the Life Insurance questions 1, 2, 3, select No, and verify the Save and continue button.");
	...
	//Step 26 - Locate the Stocks & Bonds questions select No and verify the Save and continue button.
			System.out.println("Step 26 - Locate the Stocks & Bonds questions select No and verify the Save and continue button.");
	...
	//Step 27 - Locate the Real Estate - Primary Residence question select No and verify the Save and continue button.
			System.out.println("Step 27 - Locate the Real Estate - Primary Residence question select No and verify the Save and continue button.");
	...
	//Step 28 - Locate the Real Estate - Other question select No and verify the Save and continue button.
			System.out.println("Step 28 - Locate the Real Estate - Other question select No and verify the Save and continue button.");
	...
	//Step 29 - Locate the Personal Property questions select No and verify the Save and continue button.
			System.out.println("Step 29 - Locate the Personal Property questions select No and verify the Save and continue button.");
	...
	//Step 30 - Locate the Notes Payable questions select No and verify the Save and continue button.
			System.out.println("Step 30	 - Locate the Notes Payable questions select No and verify the Save and continue button.");
	...
	//Step 31 - Locate the Assessed Taxes questions select No and verify the Save and continue button.
			System.out.println("Step 31 - Locate the Assessed Taxes questions select No and verify the Save and continue button.");
	...
	//Step 32 - Locate the Adjusted Gross Income questions select No and verify the Save and continue button.
			System.out.println("Step 32 - Locate the Adjusted Gross Income questions select No and verify the Save and continue button.");
	...
	//Step 33 - Locate the Financial Summary questions select No and verify the Save and continue button.
			System.out.println("Step 33 - Locate the Financial Summary questions select No and verify the Save and continue button.");
			if (driver.getPageSource().contains("Save and continue")){
				System.out.println("  Save and continue button is displayed - Pass");
			} else {
				System.out.println("  Save and continue button is displayed - <<FAILED>>");
	...
	//Step 34 - Locate the Privacy Statements page and verify the Save and continue button.
			System.out.println("Step 34 - Locate the Privacy Statements questions select No and verify the Save and continue button.");
	...
	//Step 35 - Locate the Review page and verify the Save and continue button.
	...
	//Step 36 - Locate the Signature page and verify the Save and continue button.
