...
//Locate the accept button at the bottom of the EDWOSB agreement and click on it to continue.
	...
	//Locate the EDWOSB 2413 and 414 Application, Financial Data and click on 'Add New Person' button at the bottom of the personal information.
	...
	Thread.sleep(2000);
	//Locate and click on the continue button without entering any data.
	mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
	//Verify that user is not being navigated to the next and section and user sees alert message 'Please answer this question' for all required field 
	if(mydriver.getPageSource().contains("Please answer this question")){
     ...
     //Locate the As of Date search box and enter a wrong date format type and verify that system rejects data type.
		mydriver.findElement(By.xpath(".//*[@id='answers_32_value']")).sendKeys(AS_of_DATE2);
		Thread.sleep(2000);
      //Verify that user sees an error message; 'Please enter a valid date'.
	...
	//Locate the cash on hand, saving and checking account search box and enter an invalid data type and verify that data type is being rejected. 
	...
	Thread.sleep(3000);
       ...
       if(mydriver.getPageSource().contains("Please answer this question")){
    	   System.out.println("invalid data type is being rejected, user sees alert; 'Please answer this question'");
       }
       else{
    	   System.out.println("invalid data type is Not being rejected, user Did Not see alert; 'Please answer this question'");
             mydriver.quit();
       }
   	Thread.sleep(3000);
...
//Locate section for 'Cash on Hand' enter all valid data as required.
	...
	//Verify that user is navigated to the Other Sources of income section.
	   if(mydriver.getPageSource().contains("Other Sources Of Income")){
		   ...
		   if(mydriver.getPageSource().contains("Please answer this question")){
			 System.out.println("Ommited question alert message 'Please answer this question' is present, pass");
				 ...
				 System.out.println("Ommited question alert message 'Please answer this question' is Not present, Failed");
...
@After
    public void US621WOSB_Self_Certifies_EDWOSB_and_8_a_Completes_the_Cash_on_Hand_and_Income_Section_Negative_Scenario_teardown()throws Exception{
	mydriver.quit();
	}
